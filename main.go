...
func run(ctx context.Context) error {
	...
	versionPrefix := "HL7v"
	//go run ./hl7Gen/*.go -pkgdir h231 -root ./genjson -version 2.3.1
	version := flag.String("version", "2.3.1", "Version of Data")
	pkgDir := flag.String("pkgdir", versionPrefix+*version, "package directory for generated files")
	rootDir := flag.String("root", "./hl7-definition", "root of data")
